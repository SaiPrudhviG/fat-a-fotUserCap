...
public class RecyclerViewAdapterItem extends RecyclerView.Adapter<RecyclerViewAdapterItem.MyViewHolder>{
    ...
    public RecyclerViewAdapterItem (JSONArray myValues ,String shop_id, Context context){
    ...
    public RecyclerViewAdapterItem.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RecyclerViewAdapterItem.MyViewHolder(listItem,context);
    }
    @Override
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    if(pos != RecyclerView.NO_POSITION){
                        ...
                        bundle.putString("shop_id", Common.getSavedUserData(context,"shopkeeper"));
